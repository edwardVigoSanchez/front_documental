...
@Component({
  selector: 'app-add-informes',
  templateUrl: './add-informes.component.html',
  styleUrl: './add-informes.component.scss'
})
export class AddInformesComponent {
  ...
  ngOnInit(): void {
    ...
    this.informesService.listConfig().subscribe((resp:any) => {
      console.log(resp);
    })
  }
  ...
  save(){
    ...
    this.informesService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
