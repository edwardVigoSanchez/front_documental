...
@Component({
  selector: 'app-add-requerimientos',
  templateUrl: './add-requerimientos.component.html',
  styleUrl: './add-requerimientos.component.scss'
})
export class AddRequerimientosComponent {
  ...
  ngOnInit(): void {
    ...
    this.requerimientosService.listConfig().subscribe((resp:any) => {
      console.log(resp);
    })
  }
  ...
  save(){
    ...
    this.requerimientosService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
