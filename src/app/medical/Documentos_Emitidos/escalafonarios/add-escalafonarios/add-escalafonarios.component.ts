...
@Component({
  ...
  templateUrl: './add-escalafonarios.component.html',
  styleUrl: './add-escalafonarios.component.scss'
})
export class AddEscalafonariosComponent {
  ...
  ngOnInit(): void {
    ...
    this.escalafonariosService.listConfig().subscribe((resp:any) => {
      console.log(resp);
    })
  }
  ...
  save(){
    ...
    this.escalafonariosService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
