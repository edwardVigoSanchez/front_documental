...
export class AddMemorandumeComponent {
  ...
  ngOnInit(): void {
    ...
    this.memorandumeService.listConfig().subscribe((resp:any) => {
      console.log(resp);
    })
  }
  ...
  save(){
    ...
    this.memorandumeService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
