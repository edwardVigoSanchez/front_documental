...
export class AddCasdirectivosComponent {
  ...
  ngOnInit(): void {
    ...
    this.casdirectivosService.listConfig().subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.casdirectivosService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
