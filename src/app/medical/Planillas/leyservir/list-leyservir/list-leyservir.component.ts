...
@Component({
  selector: 'app-list-leyservir',
  templateUrl: './list-leyservir.component.html',
  styleUrl: './list-leyservir.component.scss'
})
export class ListLeyservirComponent {
  ...
  ngOnInit() {
    this.getTableData();
    this.user = this.leyservirService.authService.user;
  }
