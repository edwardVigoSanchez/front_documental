...
export class AddPermanentesComponent {
  ...
  ngOnInit(): void {
    ...
    this.permanentesService.listConfig().subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.permanentesService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
