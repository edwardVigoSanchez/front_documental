...
export class AddDescjudicialesComponent {
  ...
  ngOnInit(): void {
    ...
    this.descjudicialesService.listConfig().subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.descjudicialesService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
