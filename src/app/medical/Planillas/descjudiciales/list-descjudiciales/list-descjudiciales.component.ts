...
export class ListDescjudicialesComponent {
  ...
  private getTableData(): void {
    ...
    this.descjudicialesService.listUsers().subscribe((resp:any) => {
  ...
  deleteUser() {
    this.descjudicialesService.deleteUser(this.descjudiciales_selected.id).subscribe((resp: any) => {
      console.log(resp);
      let INDEX = this.usersList.findIndex((item: any) => item.id == this.descjudiciales_selected.id);
      if (INDEX != -1) {
        ...
        this.descjudiciales_selected = null;
      }
    })
  }
