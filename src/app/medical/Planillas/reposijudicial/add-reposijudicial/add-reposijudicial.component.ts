...
@Component({
  selector: 'app-add-reposijudicial',
  templateUrl: './add-reposijudicial.component.html',
  styleUrl: './add-reposijudicial.component.scss'
})
export class AddReposijudicialComponent {
  ...
  ngOnInit(): void {
    ...
    this.reposijudicialService.listConfig().subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.reposijudicialService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
