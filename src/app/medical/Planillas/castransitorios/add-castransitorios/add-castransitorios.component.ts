...
export class AddCastransitoriosComponent {
  ...
  ngOnInit(): void {
    ...
    this.castransitoriosService.listConfig().subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.castransitoriosService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
