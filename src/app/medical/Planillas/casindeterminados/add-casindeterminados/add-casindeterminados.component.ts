...
@Component({
  ...
  templateUrl: './add-casindeterminados.component.html',
  styleUrl: './add-casindeterminados.component.scss'
})
export class AddCasindeterminadosComponent {
  ...
  ngOnInit(): void {
    ...
    this.casindeterminadosService.listConfig().subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.casindeterminadosService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
