...
export class AddPensionistasComponent {
  ...
  ngOnInit(): void {
    ...
    this.pensionistasService.listConfig().subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.pensionistasService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
