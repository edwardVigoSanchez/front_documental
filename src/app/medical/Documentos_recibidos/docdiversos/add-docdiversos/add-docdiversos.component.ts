...
export class AddDocdiversosComponent {
  ...
  ngOnInit(): void {
    ...
    this.docdiversosService.listConfig().subscribe((resp:any) => {
      console.log(resp);
    })
  }
  ...
  save(){
    ...
    this.docdiversosService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
