...
export class AddMemorandumComponent {
  ...
  ngOnInit(): void {
    ...
    this.memorandumService.listConfig().subscribe((resp:any) => {
      console.log(resp);
    })
  }
  ...
  save(){
    ...
    this.memorandumService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
