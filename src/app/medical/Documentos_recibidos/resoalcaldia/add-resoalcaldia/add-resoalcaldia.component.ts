...
export class AddResoalcaldiaComponent {
  ...
  ngOnInit(): void {
    ...
    this.resoalcaldiaService.listConfig().subscribe((resp:any) => {
      console.log(resp);
    })
  }
  ...
  save(){
    ...
    this.resoalcaldiaService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
