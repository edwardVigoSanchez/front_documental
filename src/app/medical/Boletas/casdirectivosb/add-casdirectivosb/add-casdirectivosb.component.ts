...
export class AddCasdirectivosbComponent {
  ...
  ngOnInit(): void {
    ...
    this.casdirectivosbService.listConfig().subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.casdirectivosbService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
