...
export class AddCasregularComponent {
  ...
  ngOnInit(): void {
    ...
    this.casregularService.listConfig().subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.casregularService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
