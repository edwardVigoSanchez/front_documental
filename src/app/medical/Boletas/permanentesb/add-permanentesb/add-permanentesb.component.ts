...
export class AddPermanentesbComponent {
  ...
  ngOnInit(): void {
    ...
    this.permanentesbService.listConfig().subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.permanentesbService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
