...
export class AddCautelaresComponent {
  ...
  ngOnInit(): void {
    ...
    this.cautelaresService.listConfig().subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.cautelaresService.registerUser(formData).subscribe((resp:any) => {
      console.log(resp);
